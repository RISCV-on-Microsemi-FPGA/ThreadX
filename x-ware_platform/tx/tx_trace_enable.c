...
UINT                            status;
    ...
    else
    {
        ...
        _tx_trace_header_ptr =  (TX_TRACE_HEADER *) ((VOID *) work_ptr);
        ...
        _tx_trace_registry_start_ptr =  (TX_TRACE_OBJECT_ENTRY *) ((VOID *) work_ptr);
        ...
        _tx_trace_registry_end_ptr =  (TX_TRACE_OBJECT_ENTRY *) ((VOID *) work_ptr);
        ...
        for (i = ((ULONG) 0); i < registry_entries; i++)
        {
            ...
            work_ptr =  TX_UCHAR_POINTER_ADD(((VOID *) _tx_trace_registry_start_ptr), (sizeof(TX_TRACE_OBJECT_ENTRY))*i);
        ...
        work_ptr =  (UCHAR *) ((VOID *) _tx_trace_registry_end_ptr);
        ...
        _tx_trace_buffer_start_ptr =      (TX_TRACE_BUFFER_ENTRY *) ((VOID *) work_ptr);
        ...
        _tx_trace_buffer_end_ptr =        (TX_TRACE_BUFFER_ENTRY *) ((VOID *) work_ptr);
        ...
        for (i = ((ULONG) 0); i < (trace_buffer_size/(sizeof(TX_TRACE_BUFFER_ENTRY))); i++)
        {
            ...
            /* Setup the work pointer.  */
            work_ptr =  TX_UCHAR_POINTER_ADD(((VOID *) _tx_trace_buffer_start_ptr), (sizeof(TX_TRACE_BUFFER_ENTRY))*i);

            /* Convert to a trace event pointer.  */
            event_ptr =  (TX_TRACE_BUFFER_ENTRY *) ((VOID *) work_ptr);
